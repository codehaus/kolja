 ...
 * 
 */
public class BenchmarkIteratorFastLineChunked extends BenchmarkIterator {
  public static void main(String[] args) throws Exception {
    BenchmarkIteratorFastLineChunked benchmark = new BenchmarkIteratorFastLineChunked();
